...
Cohesion: 0.05
Nodes (36): AdminForgotPasswordPage(), handleSubmit(), adminNav, AdminPaymentsPanel(), describePaymentOpsState(), DesktopReturnPage(), handleResendVerification(), formatInr() (+28 more)

### Community 43 - "ContextPack"
Cohesion: 0.08
Nodes (24): IReadOnlyList, IContextPackService, IContextPackRepository, DateTime, List, ContextPack, Documents, JobDescriptionSummary (+16 more)

### Community 44 - "SupportTicketRecord"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (25): EventHandlerRef, EventHotKeyRef, NSApplication, NSApplicationDelegate, NSObjectProtocol, NSPanel, NSWindow, NSWindowDelegate (+17 more)

### Community 61 - "ManagedProviderCredentialRecord"
Cohesion: 0.06
...
Cohesion: 0.24
Nodes (6): NpgsqlConnection, NpgsqlConnectionStringBuilder, PostgresDashboardStore, List, NpgsqlConnection, DashboardQueryService
...
Cohesion: 0.13
Nodes (12): DateTime, DesktopContextPackDto, JobDescriptionText, Name, PackId, ResumeText, UpdatedAtUtc, DesktopContextPackUpsertRequestDto (+4 more)

### Community 152 - "TaskViewMonitor"
Cohesion: 0.25
...
Cohesion: 0.12
Nodes (14): DateTime, ManagedAiCatalogRefreshProviderResultDto, Attempted, Label, Message, ModelCount, ProviderId, RefreshedAtUtc (+6 more)

### Community 169 - "InterviewSessionCompletionResult"
Cohesion: 0.12
Nodes (15): DateTime, List, InterviewSessionCompletionResult, ChargedBlocks, ChargedCredits, ConsumedPremiumCredits, ConsumedProCredits, EndedAtUtc (+7 more)

### Community 170 - "HostedKnowledgeBaseExperienceCardDto"
Cohesion: 0.12
...
Cohesion: 0.20
Nodes (5): Phantom.Dashboard.Backend.Infrastructure, Phantom.Dashboard.Backend.Persistence, Phantom.Dashboard.Backend.Services, AdminApiKeyFilter, AdminSessionValidator

### Community 181 - ".ApplyMigrations"
Cohesion: 0.24
...
Cohesion: 0.29
Nodes (4): HttpRequest, BrowserSessionCookieService, HttpRequest, RequestTokenResolver

### Community 190 - ".ApplyMigrations"
Cohesion: 0.24
Nodes (8): IReadOnlyList, BackendSchemaMigrations, All, DashboardProjectionOnly, IReadOnlyList, NpgsqlConnection, SchemaMigration, SchemaMigrator

### Community 191 - ".value"
Cohesion: 0.27
Nodes (4): Decoder, KeyedDecodingContainer, StartupSnapshot.KnowledgeBase, T

### Community 192 - "RagTraceLogger"
Cohesion: 0.22
Nodes (7): Enabled, Channel, Task, Value, RagTraceLogger, IsEnabled, Source

### Community 193 - "HttpHostedClientBase"
Cohesion: 0.24
...
Cohesion: 0.20
Nodes (5): ConcurrentQueue, ObservableCollection, DebugLogger, Instance, LogMessages

### Community 204 - ".InvokeAsync"
Cohesion: 0.17
Nodes (9): IEndpointFilter, EndpointFilterDelegate, EndpointFilterInvocationContext, ValueTask, AdminApiKeyFilter, EndpointFilterDelegate, EndpointFilterInvocationContext, ValueTask (+1 more)

### Community 205 - "DashboardOptions"
Cohesion: 0.17
Nodes (11): IConfiguration, DashboardOptions, AdminApiKey, DatabaseUrl, HasAdminApiKey, HasWindowsBackendAdminAccess, HasWindowsBackendInternalAccess, PublicWebsiteBaseUrl (+3 more)

### Community 206 - "ManagedAiAdminService"
Cohesion: 0.41
Nodes (3): CancellationToken, Task, ManagedAiAdminService

### Community 207 - "AdminDashboardPage"
Cohesion: 0.32
...
Cohesion: 0.17
Nodes (11): AuthRegisterRequestDto, AcceptedTerms, AppVersion, DeviceFingerprintHash, DeviceLabel, Email, InstallId, Password (+3 more)

### Community 218 - "HostedKnowledgeBaseExperienceCardUpdateRequestDto"
Cohesion: 0.17
Nodes (11): IReadOnlyList, HostedKnowledgeBaseExperienceCardUpdateRequestDto, Company, EndDate, IsCurrent, Responsibilities, Role, Skills (+3 more)

### Community 219 - "HostedKnowledgeBaseProfileCardUpdateRequestDto"
Cohesion: 0.17
Nodes (11): IReadOnlyList, HostedKnowledgeBaseProfileCardUpdateRequestDto, CandidateInfo, CurrentRole, Domains, FullName, ResumeText, ShortIntro (+3 more)

### Community 220 - "HostedKnowledgeBaseProjectCardUpdateRequestDto"
Cohesion: 0.17
...
Cohesion: 0.22
Nodes (7): DateTime, IReadOnlyList, ManagedAiCatalogDto, Providers, RefreshedAtUtc, ManagedAiCatalogDto, ManagedAiProviderOptionDto

### Community 242 - "ManagedAiRuntimeSelectionDto"
Cohesion: 0.20
Nodes (9): DateTime, ManagedAiRuntimeSelectionDto, IsConfigured, IsResolved, ModelDisplayName, ModelId, ProviderId, ProviderLabel (+1 more)

### Community 243 - "IKnowledgeBaseEmbeddingService"
Cohesion: 0.29
...
### Community 250 - "UserDashboardPage"
Cohesion: 0.39
Nodes (9): DownloadPage(), load(), UserDashboardPage(), load(), refreshSummary(), fetchAccountSummary(), fetchDownloadEntitlement(), fetchHostedKnowledgeBase() (+1 more)

### Community 251 - "sendManagedAiAdminTest"
Cohesion: 0.28
Nodes (8): formatManagedAiLatencyStatus(), ManagedAiLatencyPanel(), handleCheckLatency(), ManagedAiTesterCard(), handleSubmit(), trimAdminTesterHistory(), sendManagedAiAdminTest(), triggerManagedAiLatencyCheck()

### Community 252 - "ManagedAiAdminPanel"
Cohesion: 0.33
...
### Community 272 - "ContextPackSummary"
Cohesion: 0.25
...
### Community 282 - "DeviceRegistrationMetadataDto"
Cohesion: 0.29
...
Cohesion: 0.40
Nodes (4): CancellationToken, Task, DashboardUserSession, UserSessionValidator

### Community 288 - "build-app.sh"
Cohesion: 0.33
...
Cohesion: 0.50
Nodes (4): RetrievalScope, ActiveProject, Global, PreviousDocuments

### Community 341 - "loginAdmin"
Cohesion: 1.00
